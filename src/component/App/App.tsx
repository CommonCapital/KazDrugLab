          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
            <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-slate-400 leading-relaxed mb-8 sm:mb-10 px-4">
                Advanced AI-powered platform for protein-binding analysis, molecular modeling,
                CRISPR sequence optimization, and real-time research collaboration.
              </p>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-3xl mx-auto px-4">
                <div className="text-center">
                  ...
                  <div className="text-xs sm:text-sm text-slate-400">Protein Structures</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs sm:text-sm text-slate-400">Avg Response</div>
                </div>
              </div>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                  <div className="bg-slate-950/50 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-slate-800/30">
                    <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                      ...
                      <div>
                        <h3 className="text-sm sm:text-base font-semibold">Molecular Analysis</h3>
                        <p className="text-xs sm:text-sm text-slate-400">Real-time processing</p>
                      </div>
                    </div>
                    <div className="space-y-2 sm:space-y-3">
                      <div className="bg-slate-900/50 rounded-lg p-2.5 sm:p-3">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-xs sm:text-sm text-slate-400">Protein Docking</span>
                      ...
                      <div className="bg-slate-900/50 rounded-lg p-2.5 sm:p-3">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-xs sm:text-sm text-slate-400">SMILES Parsing</span>
                  ...
                  <div className="bg-slate-950/50 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-slate-800/30">
                    <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                      ...
                      <div>
                        <h3 className="text-sm sm:text-base font-semibold">GPU Utilization</h3>
                        <p className="text-xs sm:text-sm text-slate-400">NVIDIA Infrastructure</p>
                      </div>
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-10 sm:mb-12 lg:mb-16">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-slate-400 max-w-2xl mx-auto px-4">
                Comprehensive suite of AI-powered tools designed for cutting-edge biomedical research
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="group bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:bg-slate-900/50 hover:border-cyan-500/30 transition-all cursor-pointer">
                ...
                <h4 className="text-lg sm:text-xl font-semibold mb-2">Protein Structure Analysis</h4>
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed mb-3 sm:mb-4">
                  AI-driven protein folding prediction and 3D structure visualization with sub-angstrom precision.
                </p>
              ...
              <div className="group bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:bg-slate-900/50 hover:border-blue-500/30 transition-all cursor-pointer">
                ...
                <h4 className="text-lg sm:text-xl font-semibold mb-2">Molecular Binding</h4>
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed mb-3 sm:mb-4">
                  Predict and analyze protein-ligand interactions with advanced molecular docking algorithms.
                </p>
              ...
              <div className="group bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:bg-slate-900/50 hover:border-purple-500/30 transition-all cursor-pointer">
                ...
                <h4 className="text-lg sm:text-xl font-semibold mb-2">CRISPR Optimization</h4>
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed mb-3 sm:mb-4">
                  Design and optimize CRISPR guide sequences with AI-enhanced specificity prediction.
                </p>
              ...
              <div className="group bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:bg-slate-900/50 hover:border-green-500/30 transition-all cursor-pointer">
                ...
                <h4 className="text-lg sm:text-xl font-semibold mb-2">SMILES Parser</h4>
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed mb-3 sm:mb-4">
                  Convert and analyze chemical structures using SMILES notation with AI validation.
                </p>
              ...
              <div className="group bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:bg-slate-900/50 hover:border-orange-500/30 transition-all cursor-pointer">
                ...
                <h4 className="text-lg sm:text-xl font-semibold mb-2">Data Integration</h4>
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed mb-3 sm:mb-4">
                  Seamlessly import data from PDB, UniProt, and other major databases.
                </p>
              ...
              <div className="group bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:bg-slate-900/50 hover:border-pink-500/30 transition-all cursor-pointer">
                ...
                <h4 className="text-lg sm:text-xl font-semibold mb-2">Analytics Dashboard</h4>
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed mb-3 sm:mb-4">
                  Visualize research data with interactive charts and statistical analysis tools.
                </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
                <div>
                  ...
                  <p className="text-sm sm:text-base lg:text-lg text-slate-400 leading-relaxed mb-4 sm:mb-6">
                    Connect with researchers worldwide through our integrated messenger system.
                    Share findings, exchange data, and collaborate in real-time on breakthrough discoveries.
                  </p>
                  <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                    <li className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs sm:text-sm text-slate-400">Create dedicated spaces for research teams</div>
                      </div>
                    </li>
                    <li className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs sm:text-sm text-slate-400">Connect with other researchers worldwide</div>
                      </div>
                    </li>
                    <li className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-slate-400">
                          Just uploaded the latest protein binding results. The affinity scores are exceptional!
                        </p>
                        <div className="mt-2 sm:mt-3 bg-slate-900/50 rounded-lg p-2 sm:p-3 border border-slate-800/30">
                          <div className="flex items-center gap-2 text-[10px] sm:text-xs text-cyan-400 mb-1 sm:mb-2">
                            ...
                            <span className="truncate">binding_analysis_v2.pdb</span>
                          </div>
                          <div className="text-[10px] sm:text-xs text-slate-500">2.4 MB</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-950/50 backdrop-blur-sm border border-slate-800/50 rounded-lg sm:rounded-xl p-3 sm:p-4">
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-slate-400">
                          Excellent work! I've cross-referenced with our CRISPR data. Let's schedule a call.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-10 sm:mb-12 lg:mb-16">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-slate-400 max-w-2xl mx-auto px-4">
                Leveraging cutting-edge GPU acceleration and AI infrastructure for unprecedented research speed
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              <div className="bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-xl p-6 sm:p-8 text-center">
                ...
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed">
                  GPU-accelerated molecular dynamics simulations deliver results in minutes, not days
                </p>
              </div>
              ...
              <div className="bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-xl p-6 sm:p-8 text-center">
                ...
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed">
                  AI models trained on millions of validated protein structures and interactions
                </p>
              </div>
              ...
              <div className="bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-xl p-6 sm:p-8 text-center sm:col-span-2 lg:col-span-1">
                ...
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed">
                  Enterprise-grade cloud infrastructure that scales with your research needs
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
            <div className="bg-gradient-to-br from-slate-900/80 to-slate-900/40 backdrop-blur-xl border border-slate-800/50 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-12 shadow-2xl">
              ...
              <p className="text-sm sm:text-base lg:text-xl text-slate-400 mb-6 sm:mb-8 leading-relaxed px-4">
                Join thousands of researchers using KazDrugLab to make breakthrough discoveries in molecular biology
              </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                Advanced AI-powered biomedical research platform for molecular discovery.
              </p>
            </div>
